...
def test_l8_no_new_migration():
    ...
    # Migration head is 0022 (organizations, V3 M15). L8 itself adds none;
    # forbid any migration beyond 0022 and any "cross"-named migration.
    assert not any("cross" in n.lower() or "0023" in n for n in names), names
