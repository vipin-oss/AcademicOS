...
def test_l8_no_new_migration():
    ...
    # Migration head is 0018 (durable jobs, V3 M10). L8 itself adds none;
    # forbid any migration beyond 0018 and any "cross"-named migration.
    assert not any("cross" in n.lower() or "0019" in n for n in names), names
