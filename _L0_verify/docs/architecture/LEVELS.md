...
|---|---|---|---|---|
| L0 | Freeze & Evaluation Harness | `in_progress` | contract in-repo, capability catalog + harness, anti-patch ceilings, ADR-019…022 law text, scale law | — |
| L1 | Knowledge-Plane Contracts | `not_started` | claim/CDM/span/acl_scope schemas and ports; OpenAPI for new surfaces | L0 `done` |
...
| L6 | Evidence & Citation Extension | `not_started` | fact citations, confidence UI | L1 + L5 |
